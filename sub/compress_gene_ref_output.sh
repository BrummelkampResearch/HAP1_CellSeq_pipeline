...
declare -a tbc=(
high.gene+screen_antisense.txt
high.inputtocoupletogenes+gene_all.txt
low.gene+screen_sense.txt
high.gene+screen_sense.txt
low.gene+screen_antisense.txt
low.inputtocoupletogenes+gene_all.txt
)
